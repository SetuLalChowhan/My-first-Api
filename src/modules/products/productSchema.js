...
let singleProduct = {
    ...
    price: number().positive("price value must be a positive").integer("price value must be an integer"),

    rating: number().positive("Rating must be a positive").integer("Rating must be an integer"),
};
